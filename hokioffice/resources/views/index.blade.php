                        ...
                        <div class="row align-items-center no-gutters">
                            ...
                            <div class="col-xl-4 col-lg-4 d-none d-lg-block">
                                <div class="social_wrap d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="number">
                                        <p>Call us <a href="#">(021) 2206 3086</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 col-lg-3">
                            <div class="footer_widget ">
                                ...
                                <p>Apapun itu... bukanlah masalah bagi Hoki Office</p>
                        ...
                        <div class="col-xl-3 col-md-6 col-lg-3">
                            <div class="footer_widget ">
                                ...
                                <p>Address :Jl. Pusat Niaga Roxy Mas Blok D3 No.10, Gambir, Cideng, 10150
                                    here, your demo address.</p>
                                <ul>
                                    <li><a href="#">Phone : +atur</a></li>
                                    <li><a href="#">Email : info@hokioffice.com</a></li>
                                </ul>
